...
freq=collections.Counter(u for s in allv for u in s); import os; K=int(os.environ.get("KSYLL","80")); top80={u for u,_ in freq.most_common(K)}
...
for segs in base:
    ...
    texts.append(t)
N=min(int(os.environ.get("NDEC","80")),len(code))
...
if __name__=='__main__':
    ...
    with Pool(3) as p:
        r=run(0); r["K"]=K; print(json.dumps(r),flush=True)
