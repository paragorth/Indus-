...
## 17. The Ur excavation reports (archive.org): no sealed document with an Indus impression
...
- **Umma tag** (corpus: TAG:L, 127-705-2-4-390, unicorn): an Indus seal impression found in a Sumerian city. The descriptions available here mention no cuneiform on the tag (Scheil's 1925 drawing, obtained later from Wikimedia Commons, shows no cuneiform on the published face; STRATEGIES S150).
- **Hypothesis to test on new finds, not a reading:** the foreign-only formula **415-803(-1)** (Ur and Dilmun round seals, never at home; S103) might be an ethnic or place label used abroad (but its absence at home is not statistically significant: 0.86 expected, 0 observed; STRATEGIES S148), e.g. an Indus equivalent of cuneiform *lu₂ me-luh-ha* "man of Meluhha". Prediction: new Gulf-type seals will show 415-803 only outside the Indus valley, and never with the home opener. If a Gulf seal with 415-803 is ever found impressed on a tablet naming its owner "of Meluhha", 415-803 would become the first anchored sign pair.

- **Cross-Gulf identity (STRATEGIES S149):** the rare pair twins + W56 (Parpola 16-145) opens 8 Kalibangan sealings of one seal (91-56-2-417-890-892) and occurs on Bahrain Gulf-type seal no. 10 (Laursen 2010, reading by Parpola). It is found nowhere else. If any Mesopotamian tablet names a Dilmunite or Meluhhan merchant alongside a seal with 91-56, that would anchor it.
- **Cross-border identity trails (STRATEGIES S151, data/derived/identity-trails.json):** Kish 240-643 and 416-840, Luristan 840-413, Gonur 125-590, Ur/Dilmun 415-803, Kalibangan/Bahrain 91-56. Any outside record naming a Meluhhan at Kish, Luristan, Gonur or in the Gulf is the place to look.
