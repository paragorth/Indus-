...
- Do the digital legwork yourself: archive.org, CDLI, HathiTrust API, Met API, Crossref, Wikimedia Commons, headless Chromium (the proxy CA is installed in ~/.pki/nssdb). Ask the user only for things that need a human (logins, CAPTCHAs, physical access), and then give a direct link.
